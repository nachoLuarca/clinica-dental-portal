...
export function CtaBanner() {
  return (
    <section className="px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 rounded-4xl bg-gradient-to-br from-primary to-[#082a26] px-6 py-14 text-center text-primary-foreground sm:px-12">
        ...
        <p className="max-w-md text-primary-foreground/80">
          Sin llamadas ni esperas en línea telefónica: elige tratamiento y
